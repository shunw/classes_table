...
# science = Subject("Science", "Ms. Johnson")

# timetable = Timetable()
# timetable.add_subject("Monday", "1st", maths)
# timetable.add_subject("Monday", "2nd", science)

# print(timetable.get_subject("Monday", "1st").name, timetable.get_subject("Monday", "1st").teacher)  # Output: Mathematics
# print(timetable.get_subject("Monday", "1st").teacher)  # Output: Mr. Smith
